...
class SitRepPage extends StatelessWidget {
  ...
  Future<List<Map<String, dynamic>>> _fetchReports() async {
    try {
      final url =
          Uri.parse('http://localhost/rareportdb/sitrep_get_report.php');
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                          child: _buildTextField(
                              'Calamity Name', calamityNameController)),
                      const SizedBox(width: 500),
                    ],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child: _buildTextField(
                              'Type of Calamity', typeCalamityController)),
                      const SizedBox(width: 500),
                    ],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child: _buildTextField(
                              'Cause of Calamity', causeCalamityController)),
                      const SizedBox(width: 500),
                    ],
                  ),
                ],
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: _buildTextField(
                              'Barangay Location', barangayLocController)),
                      const SizedBox(width: 500),
                    ],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child: _buildTextField(
                              'Barangay Contact No.', barangayPnumController)),
                      const SizedBox(width: 500),
                    ],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child:
                              _buildTextField('Date of Issue', dateController)),
                      const SizedBox(width: 500),
                    ],
                  ),
                    ...
                    children: [
                      Expanded(
                          child: _buildTextBigField(
                              'Situation to Date', sitToDateController)),
                    ],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child: _buildTextBigField(
                              'Action to Date', actToDateController)),
                    ],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child: _buildTextBigField(
                              'Action to be Completed', actTobeComController)),
                    ],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                          child:
                              _buildTextBigField('Issues', issuesController)),
                    ],
                  ),
                  ...
                  Row(
                    children: [
                      Expanded(
                          child: _buildTextField(
                              'Prepared By', preparedByController)),
                      const SizedBox(width: 500),
                    ],
                  ),
                ],
  ...
  Future<void> _saveData(BuildContext context) async {
    if (calamityNameController.text.isNotEmpty &&
      ...
      try {
        ...
        final url =
            Uri.parse('http://localhost/rareportdb/sitrep_save_report.php');
