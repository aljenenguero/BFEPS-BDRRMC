  ...
  void _deleteRaReport(BuildContext context, String riskReportID) async {
    ValidationDialog.showDeleteDialog(
      ...
      onConfirm: () async {
        ...
        try {
          final url =
              Uri.parse('http://localhost/rareportdb/ra_delete_report.php');
          ...
          if (response.statusCode == 200) {
            ...
            if (responseData['success'] == true) {
              ...
              _showErrorDialog(context,
                  "Failed to delete record: ${responseData['message']}");
            }
          } else {
...
class _RAReportFormState extends State<RAReportForm> {
  ...
  final TextEditingController riskDescriptionController =
      TextEditingController();
  final TextEditingController sourceRiskController = TextEditingController();
  final TextEditingController numPerWithDisabilityController =
      TextEditingController();
  final TextEditingController numSeniorCitizenController =
      TextEditingController();
  final TextEditingController numInfantToddlersController =
      TextEditingController();
  final TextEditingController numFloodFatalityController =
      TextEditingController();
  final TextEditingController propertyDamageController =
      TextEditingController();
  ...
  final TextEditingController currentControlMeasuresController =
      TextEditingController();
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Expanded(
                                  child: _buildTextField('Name of Kagawad',
                                      kagawadNameController)),
                          ...
                          Row(
                            children: [
                              Expanded(
                                  child: _buildTextField('Risk Description',
                                      riskDescriptionController)),
                            ],
                          ),
                          const SizedBox(height: 10),
                          Row(
                            children: [
                              Expanded(
                                  child: _buildTextField(
                                      'Source of Risk', sourceRiskController)),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              Expanded(
                                  child: _buildTextField(
                                      'Person with Disability(s)',
                                      numPerWithDisabilityController)),
                              const SizedBox(width: 10),
                              Expanded(
                                  child: _buildTextField('Senior Citizen(s)',
                                      numSeniorCitizenController)),
                              const SizedBox(width: 10),
                              Expanded(
                                  child: _buildTextField(
                                      'Infant(s) & Toddler(s)',
                                      numInfantToddlersController)),
                              const SizedBox(width: 10),
                              Expanded(
                                  child: _buildTextField('Flood Fatality',
                                      numFloodFatalityController)),
                            ],
                          ),
                          const SizedBox(height: 10),
                          Row(
                            children: [
                              Expanded(
                                  child: _buildTextField('Property Damage',
                            ...
                            children: [
                              Expanded(
                                  child: _buildTextField(
                                      ...
                                      currentControlMeasuresController)),
                            ],
                          ),
                          const SizedBox(height: 10),
                          Row(
