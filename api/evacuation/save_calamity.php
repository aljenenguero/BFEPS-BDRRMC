...
$required_fields = ['date_time', 'calamity_name', 'calamity_type', 'severity_level', 'cause', 'alert_level', 'current_status'];
...
$stmt = $conn->prepare("INSERT INTO calamity_table (date_time, calamity_name, calamity_type, severity_level, cause, alert_level, current_status)
                       VALUES (?, ?, ?, ?, ?, ?, ?)");
